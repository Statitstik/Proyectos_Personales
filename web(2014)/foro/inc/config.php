...
$config['database']['database'] = 'u491638528_webdb';
$config['database']['table_prefix'] = 'mybb_';

$config['database']['hostname'] = 'mysql.hostinger.es';
$config['database']['username'] = 'u491638528_web';
$config['database']['password'] = 'teamhardblock';
